...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/TryharderKid/NOVA-HUB/refs/heads/main/Libary%20(Wasn't%20Hard%20to%20Get)", true))()
...
local teleportSwitch = rebirthsFolder:AddSwitch("Auto Teletransporte al Rey", function(bool)
